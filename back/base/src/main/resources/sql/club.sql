...
CREATE TABLE `t_club_member`  (
  ...
  `club_id` int NULL COMMENT '社团编号',
  `num_session` varchar(255) NULL COMMENT '届数',
  `member_count` varchar(255) NULL COMMENT '当前届的社团人数',
  `allocated_count` varchar(255) NULL COMMENT '分配人数',
  `enrollment_member` varchar(255) NULL COMMENT '报名人数',
  `create_time` datetime NULL COMMENT '创建时间',
  `update_time` datetime NULL COMMENT '信息修改时间',
  `deleted` tinyint NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_department_leader`  (
  `id` int NOT NULL COMMENT '主键ID',
