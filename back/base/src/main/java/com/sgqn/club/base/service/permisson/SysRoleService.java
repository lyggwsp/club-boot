...
public interface SysRoleService extends IService<SysRole> {
     ...
     * @return 是否删除成功
     */
    void removeSysRoleBatch(List<Long> roleIds);
     ...
     * @return 返回是否删除成功
     */
    void removeSysRoleById(Long id);
     ...
     * @return 返回是否更新状态成功
     */
    void updateRoleStatus(Long roleId, Boolean disabled);
     ...
     * @return 角色数组
     */
    List<SysRole> getRoleListFromCache(Collection<Long> ids);
}
